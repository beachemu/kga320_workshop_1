...
```{r list_files, exercise=TRUE, excercise.setup="call_libraries"}
```
...
```{r load_data, exercise=TRUE, excercise.setup="list_files"}
```
...
```{r basic_stats, exercise=TRUE, excercise.setup="load_data"}
```
...
```{r plot_histogram, exercise=TRUE, excercise.setup="basic_stats"}
```
...
```{r calculate_anomaly, exercise=TRUE, excercise.setup="plot_histogram"}
```

Now, try using some of the plots we have learned so far to visualise the anomaly.

```{r plot_anomaly, exercise=TRUE, excercise.setup="calculate_anomaly"}
```
...
```{r time_series, exercise=TRUE, excercise.setup="plot_anomaly"}
```
...
```{r playground, exercise=TRUE, excercise.setup="time_series"}
```
